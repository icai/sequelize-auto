...
function getModelEggFileStart(indentation, spaces, tableName) {
  var fileStart = "/* jshint indent: " + indentation + " */\n";
  fileStart += '// tslint:disable\n';
  // fileStart += 'import * as sequelize from \'sequelize\';\n';
  // fileStart += 'import {DataTypes} from \'sequelize\';\n';
  ...
  fileStart += spaces + 'const sequelize = app.model;\n';
  fileStart += spaces + 'const Model = sequelize.define<' + tableName + 'Instance, ' + tableName + 'Attribute>(\'' + tableName + '\', {\n';
  return fileStart;
}

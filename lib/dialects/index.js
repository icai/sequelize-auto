...
exports.mysql = {
  ...
  /**
   * Generates an SQL query that returns all index keys of a table.
   * @param {String} tableName
   * @param {String} schemaName
   */
  getTableIndexKeysQuery: function(tableName, schemaName) {
    return `
  ...
  /**
   * Generates an SQL query that returns all indexs of a table.
   * @param {String} tableName
   * @param {String} schemaName
   */
  getTableIndexsQuery: function(tableName, schemaName) {
    return  "SHOW INDEX FROM `"+tableName + " +`.`" + schemaName+ "`;"
  },
  /**
   * Determines if record entry from the getForeignKeysQuery
